...
_arg_regex = re.compile(r'''(?:
                            ...
                            $''',
                        re.VERBOSE)
# This'll match eg `'1-23-4'`. Also, eg `1/2`. Doesn't really matter I guess although if you feel like swapping it, I think something like this would be tighter:
# ```
# re.compile(r'''(?:
#       (                        # numbers and ranges divided by commas (1)
#         (?:\d+(?:-\d+)?)
#         (?:,(?:\d+(?:-\d+)?))*
#       )
#       |                          # or
#       (\*)(?:/(\d+))?      # asterisk (2), divisor part (3 - number part)
#     )
#     $''',
# re.VERBOSE)
# ```
